...
It is good practice to use use prefix for classes and contant names.
...
## CGRect Functions (should we keep it? my experience shows that develoepers never use those functions.)
